...
<body>
    ...
    <main>
        <section class="login">
            ...
            <form class="login__label" action="cadastro.php" method="$_POST">
            ...
            <div class="wrapper">
                <button type="submit" class="login__button" a href="index.php">
                ...
                <p>Esqueceu sua Senha?<a href="./novasenha.php" class="login__link"> Nova Senha </a></p>
            </div>
